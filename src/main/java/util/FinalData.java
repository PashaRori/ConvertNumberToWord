...
public class FinalData {
    ...
    public static final String[] RussianDifferenceArrayZeroToOneHundred = new String[]{"ноль", "один", "два", "три"};
    public static final String[] EnglishDifferenceArrayZeroToOneHundred = new String[]{"zero", "one", "two", "three"};
    public static final String[] RussianDifferenceOneHundredToOneThousand = new String[]{"сто", "двести"};
    public static final String[] RUSSIAN_DIFFERENCE_EXCEL_ARRAY = new String[]{"ноль", "один", "два", "три", "четыре"};
    public static final String[] ENGLISH_DIFFERENCE_EXCEL_ARRAY = new String[]{"zero", "one", "two"};
    public static final String[] RussianOneHundredToOneThousand = {"сто", "двести", "триста", "четыреста", "пятьсот", "шестьсот", "семьсот", "восемьсот", "девятьсот"};
    public static final String[] EnglishDifferenceOneHundredToOneThousand = new String[]{"one hundred", "two hundred", "three hundred"};
    public static final String[] RussianDifferenceOneThousandToMaximumAvailableNumber = new String[]{"тысяч", "миллион", "миллиард"};
    public static final String[] EnglishDifferenceOneThousandToMaximumAvailableNumber = new String[]{"thousand", "million", "billion", "trillion"};
    public static final String[] EnglishOneHundredToOneThousand = new String[]{"one hundred", "two hundred", "three hundred", "four hundred", "five hundred", "six hundred", "seven hundred", "eight hundred", "nine hundred"};
    public static final String[] RussianOneThousandToMaximumAvailableNumber = new String[]{"тысяч", "миллион", "миллиард", "триллион", "квадриллион", "квинтиллион", "секстиллион", "септиллион", "октиллион", "нониллион", "дециллион", "андециллион", "дуодециллион", "тридециллион", "квадридециллион", "квинтидециллион", "секстидециллион", "септидециллион", "октидециллион", "нонидециллион", "децидециллион"};
    public static final String[] EnglishOneThousandToMaximumAvailableNumber = new String[]{"thousand", "million", "billion", "trillion", "quadrillion", "quintillion", "sextillion", "septillion", "octillion", "quintillion", "decillion", "andecillion", "duodecillion", "tridecillion", "quadrillion", "quintidecillion", "sextidecillion", "septidecillion", "octidecillion", "nonidecillion", "decidecillion"};
    public static final String[] RUSSIAN_EXCEL_ARRAY = new String[]{"ноль", "один", "два", "три", "четыре", "пять", "шесть", "семь", "восемь", "девять", "десять", "одиннадцать", "двенадцать", "тринадцать", "четырнадцать", "пятнадцать", "шестнадцать", "семнадцать", "восемнадцать", "девятнадцать", "двадцать", "тридцать", "сорок", "пятьдесят", "шестьдесят", "семьдесят", "восемьдесят", "девяноста", "сто", "двести", "триста", "четыреста", "пятьсот", "шестьсот", "семьсот", "восемьсот", "девятьсот", "тысяч", "миллион", "миллиард", "триллион", "квадриллион", "квинтиллион", "секстиллион", "септиллион", "октиллион", "нониллион", "дециллион", "андециллион", "дуодециллион", "тридециллион", "квадридециллион", "квинтидециллион", "секстидециллион", "септидециллион", "октидециллион", "нонидециллион", "децидециллион"};
